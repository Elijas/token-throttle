...
```bash
pip install "token-throttle[redis,tiktoken]>=12.0.0,<13.0.0"   # OpenAI + Redis (recommended)
pip install "token-throttle[redis]>=12.0.0,<13.0.0"            # Any provider + Redis
pip install "token-throttle>=12.0.0,<13.0.0"                   # Any provider + in-memory
```
...
```bash
pip install "token-throttle[redis,tiktoken]>=12.0.0,<13.0.0" openai
```
