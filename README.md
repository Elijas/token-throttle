...
```bash
pip install "token-throttle[redis,tiktoken]>=5.2.0,<5.3.0"   # OpenAI + Redis (recommended)
pip install "token-throttle[redis]>=5.2.0,<5.3.0"            # Any provider + Redis
pip install "token-throttle>=5.2.0,<5.3.0"                   # Any provider + in-memory
```
