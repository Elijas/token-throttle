...
```bash
pip install "token-throttle[redis,tiktoken]>=11.0.0,<12.0.0"   # OpenAI + Redis (recommended)
pip install "token-throttle[redis]>=11.0.0,<12.0.0"            # Any provider + Redis
pip install "token-throttle>=11.0.0,<12.0.0"                   # Any provider + in-memory
```
...
```bash
pip install "token-throttle[redis,tiktoken]>=11.0.0,<12.0.0" openai
```
