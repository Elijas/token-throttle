...
```bash
pip install "token-throttle[redis,tiktoken]>=10.1.0,<11.0.0"   # OpenAI + Redis (recommended)
pip install "token-throttle[redis]>=10.1.0,<11.0.0"            # Any provider + Redis
...
```bash
pip install "token-throttle[redis,tiktoken]>=10.1.0,<11.0.0" openai
```
