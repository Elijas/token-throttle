...
```bash
pip install "token-throttle[redis,tiktoken]>=10.2.0,<11.0.0"   # OpenAI + Redis (recommended)
pip install "token-throttle[redis]>=10.2.0,<11.0.0"            # Any provider + Redis
pip install "token-throttle>=10.2.0,<11.0.0"                   # Any provider + in-memory
```
...
```bash
pip install "token-throttle[redis,tiktoken]>=10.2.0,<11.0.0" openai
```
