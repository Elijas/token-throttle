...
[![PyPI Version](https://img.shields.io/badge/v0.5.0-version?color=43cd0f&style=flat&label=pypi)](https://pypi.org/project/token-throttle)
...
pip install "token-throttle>=0.5.0,<0.6.0"                   # Any provider + in-memory
```
