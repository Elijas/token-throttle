...
```bash
pip install "token-throttle[redis,tiktoken]>=4.0.0,<4.1.0"   # OpenAI + Redis (recommended)
pip install "token-throttle[redis]>=4.0.0,<4.1.0"            # Any provider + Redis
pip install "token-throttle>=4.0.0,<4.1.0"                   # Any provider + in-memory
```
