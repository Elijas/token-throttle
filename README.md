...
```bash
pip install "token-throttle[redis,tiktoken]>=13.0.0,<14.0.0"   # OpenAI + Redis (recommended)
pip install "token-throttle[redis]>=13.0.0,<14.0.0"            # Any provider + Redis
pip install "token-throttle>=13.0.0,<14.0.0"                   # Any provider + in-memory
```
...
```bash
pip install "token-throttle[redis,tiktoken]>=13.0.0,<14.0.0" openai
```
