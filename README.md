...
```bash
pip install "token-throttle[redis,tiktoken]>=8.0.5,<8.1.0"   # OpenAI + Redis (recommended)
pip install "token-throttle[redis]>=8.0.5,<8.1.0"            # Any provider + Redis
pip install "token-throttle>=8.0.5,<8.1.0"                   # Any provider + in-memory
```
