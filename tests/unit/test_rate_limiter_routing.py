...
class TestAcquireCapacityForRequestMerge:
    ...
    async def test_fixed_signature_counter_ignores_unrequested_kwargs(self):
        builder, mock_backend = make_mock_backend_builder()
    ...
    async def test_positional_only_required_param_raises_clear_error(self):
    ...
    async def test_positional_only_required_param_with_var_keyword_raises_clear_error(
        self,
    ):
